...
df = pd.read_csv('IoTforHire.csv')

# define the bill format (will change based on our csv total rows and columns, will modify later)
font_size = 12
header_font_size = 16
...
c.drawString(margin, height - margin - header_line_height, 'IoT Bill for customers')
