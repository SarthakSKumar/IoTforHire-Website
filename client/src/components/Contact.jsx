    ...
    <section id="contact" className="bg-white dark:bg-gray-900">
      <div className="max-w-screen-xl px-4 py-14 pb-8 mx-auto lg:pb-16">
        ...
        <div className="flex  my-10 md:flex-row flex-col justify-around items-center">
          <div className="flex rounded-lg bg-gray-100 dark:bg-gray-800 my-3 flex-wrap justify-center md:w-[30rem]">
            <h3 className="text-xl font-semibold text-gray-700 dark:text-gray-300 px-5 md:py-6 py-6 text-center">
              Have components and want to <br />
          ...
          <div className="flex rounded-lg bg-gray-100 dark:bg-gray-800 p-4 mx-2 flex-wrap justify-evenly w-full md:w-[30rem]">
